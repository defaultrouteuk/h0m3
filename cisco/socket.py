...
def netstat():
    ...
    for line in content:
        ...
        if nline[3] != "0.0.0.0:0" and nline[2] != "198.51.100.17:22":                     # return only remote conns
            result.append(nline) # add to string if found
    return result
    # return nline
...
if __name__ == '__main__':
    # for conn in netstat():
        for sockets in netstat():  # type is list and array number is item in list
            socket=(sockets[3])
            print(socket)
